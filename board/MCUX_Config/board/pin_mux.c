...
- pin_list:
  ...
  - {pin_num: '79', peripheral: LPUART0, signal: TX, pin_signal: P0_3/TDI/LPUART0_TXD/LPSPI0_SDO/CT0_MAT1/UTICK_CAP1/FLEXIO0_D3/CMP0_OUT, slew_rate: fast, open_drain: disable,
    drive_strength: low, pull_select: up, pull_enable: enable, input_buffer: enable, invert_input: normal}
  - {pin_num: '30', peripheral: LPUART2, signal: TX, pin_signal: P2_10/TRIG_OUT5/LPUART2_TXD/CT3_MAT2/FLEXIO0_D18, open_drain: disable, pull_select: up, pull_enable: enable}
  - {pin_num: '31', peripheral: LPUART2, signal: RX, pin_signal: P2_11/TRIG_IN4/LPUART2_RXD/CT3_MAT3/FLEXIO0_D19, pull_select: up, pull_enable: enable}
  - {pin_num: '26', peripheral: ADC1, signal: 'A, 0', pin_signal: P2_4/LPUART2_CTS_B/CT_INP14/CT1_MAT0/FLEXIO0_D12}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    PORT2->PCR[4] = ((PORT2->PCR[4] &
                     ...
                     /* Pin Multiplex Control: PORT2_4 (pin 26) is configured as ADC1_A0. */
